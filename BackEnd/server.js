...
//   console.error(
//     "❌ ERROR: MongoDB Atlas connection string not found or invalid!"
//   );
//   console.error(
//     "Please set MONGODB_URI in your .env file with a valid Atlas connection string."
//   );
//   console.error(
//     "Example: mongodb+srv://username:password@cluster0.xxxxx.mongodb.net/database"
//   );
//   process.exit(1);
// }
